...
#Program issues: does not calculate the next station from the nearest rail stn. I was not able to understand how the 
#........different pieces of data in GTS worked together despite thorough research, inquiries and time consumed. 
#........This is the best of my knowledge about the subject, but I am happy with my work because I was able to figure out (and learnt a lot) the first few parts of the task.  
